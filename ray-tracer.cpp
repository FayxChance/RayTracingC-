...
// Objects
    ...
    Sphere *sphere2 = new Sphere(bouleOriginelPos + 3.0f * xUnit + 0.0f * yUnit + 0.0f * zUnit, radius,
                                 Material::emerald());
    Sphere *sphere3 = new Sphere(bouleOriginelPos + 6.0f * xUnit + 0.0f * yUnit + -5.0f * zUnit, radius * 4,
    ...
    PeriodicPlane *pplane = new PeriodicPlane(Point3(0.0, 0.0, 10.0), Vector3(5.0, 0.0, 0.0), Vector3(0.0, 5.0, 0.0),
